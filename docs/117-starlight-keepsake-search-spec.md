...
| ID | 中心 / 半径 | label | note |
| --- | --- | --- | --- |
| `k1` | `(160,150) / 58` | 那张车票 | 原来期待一件事，也可以从和你一起出发开始。 |
| `k2` | `(820,145) / 58` | 两只杯子 | 平常的清晨，因为多了一只杯子，就有了名字。 |
| `k3` | `(285,445) / 58` | 没拍完的照片 | 有些瞬间不够端正，却刚好是我们。 |
| `k4` | `(680,455) / 58` | 放在一起的钥匙 | 从某一天起，回来不再只是回到一个地方。 |
| `k5` | `(855,330) / 58` | 窗边那颗星 | 最晚亮起的那颗，也一直没有错过我们。 |
...
TARGETS = [
  { id: "k1", x: 160, y: 150, radius: 58 },
  { id: "k2", x: 820, y: 145, radius: 58 },
  { id: "k3", x: 285, y: 445, radius: 58 },
  { id: "k4", x: 680, y: 455, radius: 58 },
  { id: "k5", x: 855, y: 330, radius: 58 },
]
```
